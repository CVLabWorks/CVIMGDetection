...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--dataroot', default='./genimage', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        # parser.add_argument('--classes', default='adm', help='image classes to train on')
        parser.add_argument('--classes', default='adm,biggan,glide,midjourney,sdv5,vqdm,wukong',
        ...
        parser.add_argument('--name', type=str, default='7class-adm-biggan-glide-midjourney-sdv5-vqdm-wukong', help='name of the experiment. It decides where to store samples and models')
